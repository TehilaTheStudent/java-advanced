...
//<editor-fold desc="my try with stream">
        ...
        integerList.stream().peek(i->{i.toString();  System.out.println();int i1 = 9; System.out.println(i1);});
        integerList.stream().filter(i->{int l=i.toString().length();return (l==0);}).limit(90);
